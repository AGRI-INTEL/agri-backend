...
export function PricingCards() {
  ...
  return (
    <section className="py-32 px-4 bg-slate-50 scroll-mt-24 relative overflow-hidden" id="tarifs" aria-labelledby="pricing-heading">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/5 rounded-full blur-[120px] translate-x-1/4 -translate-y-1/4" />
      ...
      <div className="max-w-content mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Choisissez le plan qui vous fait <span className="text-emerald-600">gagner du temps</span>
          </motion.h2>
          ...
          >
            ...
            >
              Annuel
              <span className="rounded-lg bg-emerald-500 px-2 py-0.5 text-[10px] font-black text-white uppercase tracking-wider">
                -20%
              </span>
            </button>
          </motion.div>
          ...
          {PRICING_PLANS.map((plan, index) => (
            <article
              ...
              className={cn(
                ...
                plan.highlighted
                  ? 'bg-slate-900 border-slate-800 shadow-[0_32px_80px_rgba(15,23,42,0.25)] scale-[1.05] z-10 text-white'
                  : 'bg-white border-slate-100 hover:shadow-2xl hover:shadow-slate-200/50 hover:border-slate-200 text-slate-900'
              )}
            >
              <motion.div
              ...
              >
                ...
                <div className="mb-10 relative z-10">
                  <div className="flex items-center justify-between gap-4 mb-6">
                    ...
                    <span className={cn(
                      ...
                      plan.highlighted ? "bg-emerald-500 text-white" : "bg-emerald-50 text-emerald-600"
                    )}>{plan.badge}</span>
                  </div>
                ...
                <div className={cn(
                  "h-px w-full mb-10 opacity-10",
                  plan.highlighted ? "bg-white" : "bg-slate-900"
                )} />
